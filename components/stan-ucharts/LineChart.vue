...
export default {
	...
	mounted() {
		let defaultOption = {
			...
			padding: [0, 15, 15, 15], //画布填充边距，顺序为上右下左，同css，但必须4位
			...
			fontSize: 14, //全局默认字体大小（可选，单位为px，默认13px）高分屏不必乘像素比，自动根据pixelRatio计算
			...
			xAxis: {
				...
				scrollAlign: 'right', //滚动条初始位置，left为数据整体左对齐，right为右对齐
			...
			legend: {
				...
				// fontColor:'666666',
				lineHeight:30,//默认opts.fontSize+5
