				...
				let countdown = setInterval(() => {
					...
					uni.getLocation({
						...
						success: function(res1) {
							...
							uni.request({
							    url :'https://restapi.amap.com/v3/geocode/regeo?output=JSON&key=959105ce52c4f0532730fafd3bed2a1e&location='+res1.longitude+','+res1.latitude, //仅为示例，并非真实接口地址。
							    data: {},
							    success: (res) => {
